...
<div class="container">
  ...
  <table class="table table-bordered">
	...
	$email = $_SESSION['email'];
	$query = "SELECT username,weight,gender,problem,previous_medical,Appon_date,Appon_status FROM patient_table,appointment where patient_table.email=appointment.P_email and appointment.D_email='$email'"; 
	$result = mysqli_query($link,$query);
	echo "<thead>";
     echo "<tr>";
