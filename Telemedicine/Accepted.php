...
<div class="container">
  ...
  <table class="table table-bordered">
	...
	$email = $_SESSION['email'];
	$query = "SELECT username,weight,gender,problem,previous_medical,Appon_date FROM patient_table,appointment where patient_table.email=appointment.P_email and appointment.D_email='$email' and appointment.Appon_status='ACCEPTED'";
	$result = mysqli_query($link,$query);
	echo "<thead>";
     echo "<tr>";
